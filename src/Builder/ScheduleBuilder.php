...
class ScheduleBuilder
{
    ...
    /**
     * @var array<string, int|string|array<int, int>> Schedule data
     */
     ...
     * Set weekdays.
     *
     * @param array<int, int> $days Days of the week (1=Mon, 7=Sun)
     *
     * @return $this
     */
     ...
     *
     * @return array<string, int|string|array<int, int>> Schedule data
     */
